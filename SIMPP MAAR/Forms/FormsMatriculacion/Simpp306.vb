...
Namespace Forms.FormsReportes
    Public Class Simpp306

        Private Sub Simpp306_Load(sender As Object, e As EventArgs) Handles MyBase.Load
            FillAll()
        End Sub
        ...
        Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
            ListaEstudiantesFac = New Simpp305B(2)
        ...
        Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
            If lblMatricula.Text.Length = 0 Then
                Return
            End If
            Reporte = New Reporte(1, Convert.ToInt32(lblMatricula.Text))
            Reporte.Show()
        End Sub
    End Class
End Namespace