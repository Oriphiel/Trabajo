...
Namespace Forms.FormsReportes
    Public Class Simpp401
        ...
        Private Sub btnInforme_Click(sender As Object, e As EventArgs) Handles btnInforme.Click
            If chbTodos.CheckState = CheckState.Checked Then
                If _op = 0 Then
                    Reporte = New Reporte(6, 0)
                    Reporte.Show()
                Else
                    Reporte = New Reporte(5, 0)
                    Reporte.Show()
                End If
            Else
                ...
                If _op = 0 Then
                    Reporte = New Reporte(6, idcurso, periodo)
                    Reporte.Show()
                Else
                    Reporte = New Reporte(5, idcurso, periodo)
                    Reporte.Show()
                End If
            End If
        End Sub

        Private Sub Simpp401_Load(sender As Object, e As EventArgs) Handles MyBase.Load
