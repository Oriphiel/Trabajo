    ...
    Public Class Simpp404
        ...
        Private Sub btnInforme_Click(sender As Object, e As EventArgs) Handles btnInforme.Click
            ...
            Else
                ...
                Reporte = New Reporte(8, idcurso, periodo)
                Reporte.Show()
            End If
        End Sub

        Private Sub Simpp404_Load(sender As Object, e As EventArgs) Handles MyBase.Load
