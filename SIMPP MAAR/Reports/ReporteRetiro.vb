...
Public Class ReporteRetiro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPP_MAAR.ReporteRetiro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteRetiro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteRetiro = New ReporteRetiro()
        rpt.Site = Me.Site
        Return rpt
    End Function
