...
Public Class ReporteCuotasMeses
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMPP_MAAR.ReporteCuotasMeses.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteCuotasMeses
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteCuotasMeses = New ReporteCuotasMeses()
        rpt.Site = Me.Site
        Return rpt
    End Function
